...
describe('Collection e2e test', () => {
  ...
  describe('new Collection page', () => {
    ...
    it('should create an instance of Collection', () => {
      cy.get(`[data-cy="uuid"]`).type('83b14d44-6894-4f37-95e2-703ee8514a91');
      cy.get(`[data-cy="uuid"]`).invoke('val').should('match', new RegExp('83b14d44-6894-4f37-95e2-703ee8514a91'));

      cy.get(`[data-cy="name"]`).type('flaky around cloakroom');
      cy.get(`[data-cy="name"]`).should('have.value', 'flaky around cloakroom');

      cy.get(`[data-cy="description"]`).type('alongside consequently desktop');
      cy.get(`[data-cy="description"]`).should('have.value', 'alongside consequently desktop');
