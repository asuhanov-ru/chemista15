...
public class BookAsserts {
    ...
    public static void assertBookUpdatableFieldsEquals(Book expected, Book actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getMediaStartPage()).as("check mediaStartPage").isEqualTo(actual.getMediaStartPage()))
            .satisfies(e -> assertThat(e.getMediaEndPage()).as("check mediaEndPage").isEqualTo(actual.getMediaEndPage()));
    }
