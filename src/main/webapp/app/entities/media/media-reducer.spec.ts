...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './media.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MEDIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDIA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDIA actions', async () => {
      const arg = 42666;
