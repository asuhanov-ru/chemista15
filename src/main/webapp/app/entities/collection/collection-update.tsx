...
export const CollectionUpdate = () => {
  ...
  const handleClose = () => {
    navigate('/collection' + location.search);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="chemista15App.collection.home.createOrEditLabel" data-cy="CollectionCreateUpdateHeading">
            <Translate contentKey="chemista15App.collection.home.createOrEditLabel">Create or edit a Collection</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('chemista15App.collection.uuid')}
                id="collection-uuid"
                name="uuid"
                data-cy="uuid"
                type="text"
              />
              <ValidatedField
                label={translate('chemista15App.collection.name')}
                id="collection-name"
                name="name"
                data-cy="name"
                type="text"
              />
              <ValidatedField
                label={translate('chemista15App.collection.description')}
