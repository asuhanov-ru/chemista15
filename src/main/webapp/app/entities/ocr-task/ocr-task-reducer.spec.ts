...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ocr-task.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OCRTASK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OCRTASK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OCRTASK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OCRTASK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OCRTASK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OCRTASK actions', async () => {
      const arg = 42666;
